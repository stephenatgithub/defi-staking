...
contract Staker {
  ...
  function withdrawalTimeLeft() public view returns (uint256 outputwithdrawalTimeLeft) {
  ...
  function claimPeriodLeft() public view returns (uint256 outputclaimPeriodLeft) {
